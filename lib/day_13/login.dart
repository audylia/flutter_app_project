...
import 'package:flutter_app_project/day_13/bottom_nav.dart';

class LoginDay13ByAdul extends StatelessWidget {
  const LoginDay13ByAdul({super.key});
