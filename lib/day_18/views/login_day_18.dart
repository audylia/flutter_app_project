...
import 'package:flutter_app_project/day_18/database/db_helper.dart';
import 'package:flutter_app_project/day_18/models/user_login_model.dart';
...
class _LoginDay18SQFLITEState extends State<LoginDay18SQFLITE> {
  ...
  void login() async {
    ...
    if (pengguna != null) {
      context.pushAndRemoveAll(BottomNavFlutter8());
    } else {
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      ...
                      context.push(const BottomNavFlutter8());
                    },
